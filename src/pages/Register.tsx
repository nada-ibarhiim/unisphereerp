...
export default function Register({ onLogin }: RegisterProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const role = email.endsWith('@iu.edu.eg')
        ? 'ADMIN'
        : 'STUDENT';
    ...
    <div className="min-h-screen bg-ui-bg flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="md:w-1/2 bg-brand-pink p-12 text-white flex flex-col justify-between relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-white/70 text-base font-medium leading-relaxed">
              Create your account and explore a world of limitless learning and management possibilities.
            </p>
          </div>

          <div className="relative z-10 pt-10">
            <p className="text-[11px] text-white/50 font-bold tracking-widest uppercase mb-4">
        ...
        <div className="md:w-1/2 p-10 lg:p-14 flex flex-col justify-center">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-ui-text mb-1">
              Create Account
            </h2>

            <p className="text-ui-muted text-sm font-medium">
              Join UniSphere Management System
            </p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-ui-muted uppercase tracking-wider ml-1">
                Email Address
              </label>

              <div className="relative group">
                <Mail
                  className="absolute left-4 top-1/2 -translate-y-1/2 text-ui-muted group-focus-within:text-brand-pink transition-colors"
                  size={16}
                />
            ...
            <div className="flex items-center gap-2 px-1 mb-2">
              ...
              <label
                htmlFor="show-pass"
                className="text-xs font-bold text-ui-muted cursor-pointer"
              >
                Show Passwords
              </label>
            </div>
